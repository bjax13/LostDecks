...
- [Home](./home.md) covers the landing page, primary nav, catalog tiles, today tiles, and getting-started CTAs.
...
- [About and feedback](./about.md) covers the About page and the footer Feedback dialog.
