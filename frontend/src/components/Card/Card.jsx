...
export default function Card({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: flip card uses a styled div for 3D layout, not a native control
    <div
    ...
    >
      <div className="card-inner">
        ...
        <div className="card-back">
          <div className="card-back-content">{backContent}</div>
          {isNonsense && stampPosition && (
            <div className="card-stamp" style={getStampStyle(stampPosition)}>
              NONSENSE
            </div>
          )}
        </div>
