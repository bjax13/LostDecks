...
- Login `Sign In` and modal `Sign In` are different headings. After a gated redirect the page heading includes `ShardStash`; the modal heading is exactly `Sign In`.
